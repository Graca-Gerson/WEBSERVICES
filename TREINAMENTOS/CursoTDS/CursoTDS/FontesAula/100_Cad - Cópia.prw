...
//    4) xxxNome da função a ser executada para validar uma inclusao ou alteração.

User Function Cadxx()

Local cVldAlt := ".T."        // Validacao da inclusao/alteracao.
Local cVldE := "u_VldExc()" // Validacao da exclusao.

AxCadastro("SxxZ1", "Cadastro de Contas", cVldExc, cVldAlt)
